    ...
    <div style={{ minHeight:"100vh", background:"#E8EDF2", fontFamily:"'Montserrat',sans-serif" }}>
      ...
      <div style={{ maxWidth:1300, margin:"0 auto", padding:"24px 32px 80px" }}>
        ...
        <div style={{ display:"flex", gap:12, flexWrap:"wrap", marginBottom:20 }}>
          {[
            { label:"Materiais cadastrados", value:totalItens, cor:"#1B3F7A" },
            { label:"Total em estoque", value:`${valorTotalUnidades} un.`, cor:"#0891b2" },
            { label:"Estoque baixo", value:emBaixoEstoque.length, cor:emBaixoEstoque.length>0?"#dc2626":"#aaa" },
          ].map((s,i) => (
